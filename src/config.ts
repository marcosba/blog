...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://marcosba.netlify.app",
  // [CONFIG:SITE_TITLE]
  title: "Marcosba's Blog",
  // [CONFIG:SITE_DESCRIPTION]
  description: "A technical blog by Marcosba",
  // [CONFIG:SITE_AUTHOR]
  author: "Marcosba",
  ...
  footer: {
    ...
    content: `© 2024 {author}. Built with the <a href="https://github.com/davidvkimball/astro-modular" target="_blank">Astro Modular</a> theme.`,
  ...
  navigation: {
    ...
    pages: [
      ...
      { title: "GitHub", url: "https://github.com/marcosba/blog/" },
    ],
    ...
    social: [
      ...
      {
        title: "GitHub",
        url: "https://github.com/marcosba/blog/",
        icon: "github",
      },
    ],
  },
